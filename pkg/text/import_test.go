...
func TestImporterPreImportWithStudio(t *testing.T) {
	...
	err := i.PreImport(testCtx)
	assert.Nil(t, err)
	assert.Equal(t, existingStudioID, *i.text.StudioID)
...
func TestImporterPreImportWithPerformer(t *testing.T) {
	...
	err := i.PreImport(testCtx)
	assert.Nil(t, err)
	assert.Equal(t, []int{existingPerformerID}, i.text.PerformerIDs.List())
...
func TestImporterPreImportWithGroup(t *testing.T) {
	...
	err := i.PreImport(testCtx)
	assert.Nil(t, err)
	assert.Equal(t, existingGroupID, i.text.Groups.List()[0].GroupID)
...
func TestImporterPreImportWithTag(t *testing.T) {
	...
	err := i.PreImport(testCtx)
	assert.Nil(t, err)
	assert.Equal(t, []int{existingTagID}, i.text.TagIDs.List())
